...
The features of `ipyvizzu-story` that are available in `PyCharm Professional`
are marked with a green check.
...
Try `ipyvizzu-story` in `PyCharm Professional` with the following sample.
